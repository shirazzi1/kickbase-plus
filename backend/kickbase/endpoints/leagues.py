...
class Market_Players:
    ...
    def __init__(self, market_players_dict: dict):
        ...
        self.offers: list = market_players_dict.get("ofs", None) ### Only ever the user's OWN offers
    ...
    def own_offer(self, own_user_id: str) -> float:
        ...
        The bidder is still checked against the user's own ID in both places. A foreign
        bid must never be reported as the user's own, whatever the API starts exposing.
